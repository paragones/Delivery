...
class MapsActivityCurrentPlace : AppCompatActivity(), OnMapReadyCallback {
    ...
    override fun onMapReady(map: GoogleMap) {
        ...
        mMap!!.setInfoWindowAdapter(object : GoogleMap.InfoWindowAdapter {
            ...
            fun getInfoWindow(arg0: Marker): View? = null
    ...
    private fun showCurrentPlace() {
        ...
        if (mLocationPermissionGranted) {
            ...
            placeResult?.addOnCompleteListener { task ->
                ...
                Log.e(TAG, "task $task")
                Log.e(TAG, "task.result ${task.result != null}")
                ...
                if (task.isSuccessful && task.result != null) {
                    ...
                    for (placeLikelihood in likelyPlaces) {
                        ...
                        mLikelyPlaceAddresses?.set(i, placeLikelihood.place
                                .address as String)
                        mLikelyPlaceAttributions?.set(i, placeLikelihood.place
                                .attributions as String)
                        mLikelyPlaceLatLngs?.set(i, placeLikelihood.place.latLng)
